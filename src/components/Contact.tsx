...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 81 9.8763-0519",
      link: "https://wa.me/5581987630519?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "professorandersonsousa@gmail.com",
      link: "mailto:professorandersonsousa@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Jaboatão dos Guararapes",
      description: "Dois Carneiros, 203",
      link: "https://maps.app.goo.gl/RcoEQbygNN7NhtyA7",
