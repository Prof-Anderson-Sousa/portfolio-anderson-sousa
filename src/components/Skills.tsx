...
export function Skills() {
    const educations = [
        {
            name: "Licenciatura em Computação | UFRPE"
        },
        {
            name: "Técnico em Manut. & Sup. em Informática | LEIAUT"
        },
        {
            name: "Curso Web Moderno Completo com JavaScript | COD3R"
        }
    ]
          ...
          <div className="container mx-auto max-w-4xl p-4 py-12">
            <div className="relative mb-4 p-4 text-center">
              ...
              <p className="relative text-sm text-gray-700">
                Full-Stack Developer | HTML5 | CSS3 | JavaScript | React.js | Python | Java
              </p>
